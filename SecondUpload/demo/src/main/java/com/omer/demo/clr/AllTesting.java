...
public class AllTesting  implements CommandLineRunner {
	...
	System.out.println("Company Tests: Upload 3 companies:");
	System.out.println("------------------------------------------------------------------");
	...
	System.out.println("------------------------------------------------------------------");
		...
		c2.setEndDate(date4);
		Date date5 =(DateUtils.convertDate (new Date(2020, 05, 10)));
		c2.setEndDate(date5);
		c2.setAmount(10);
		...
		c3.setPrice(550.00);
		Date date6 =(DateUtils.convertDate(new Date(2020, 11, 10)));
		c3.setEndDate(date4);
		Date date7 = (DateUtils.convertDate(new Date(2020, 05, 10)));
		c3.setEndDate(date5);
		c3.setAmount(13);
		c3.setImage("http://pizza.com");
