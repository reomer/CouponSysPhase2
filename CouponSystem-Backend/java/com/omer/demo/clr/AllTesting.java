...
public class AllTesting  implements CommandLineRunner {
	...
	comp6.setName("Hike");
	comp6.setEmail("shop@Hike.com");
	comp6.setPassword("4321");
	
	Company comp7 = new Company();
	comp7.setName("Atari");
	comp7.setEmail("shop@Atari.com");
	comp7.setPassword("4444");
	
	Company comp8 = new Company();
	comp8.setName("SAGA");
	comp8.setEmail("shop@saga.com");
	comp8.setPassword("1234");
	...
	companyDBDAO.addCompany(comp6);
	companyDBDAO.addCompany(comp7);
	companyDBDAO.addCompany(comp8);
...
//	System.out.println(companyDBDAO.getAllCompanies());
	...
	System.out.println("Company Tests:Company update test");
...
//		
		...
		System.out.println("Company Tests: Coupon Update test");
...
//		System.out.println("Before Delete"+couponDBDAO.getAllCoupons());
		...
		customer5.setFirstName("SLIM");
		customer5.setLastName("SHADY");
		customer5.setEmail("EMINEN@gmail.com");
		customer5.setPassword("1234");
		
		customerDBDAO.addCustomer(customer5);
		
		Customer customer6= new Customer();
		customer6.setFirstName("Missy");
		customer6.setLastName("Eliot");
		customer6.setEmail("missy@gmail.com");
		customer6.setPassword("1234");
		
		customerDBDAO.addCustomer(customer6);
		
		Customer customer7= new Customer();
		customer7.setFirstName("Basta");
		customer7.setLastName("Rhyems");
		customer7.setEmail("BR@gmail.com");
		customer7.setPassword("1234");
		
		customerDBDAO.addCustomer(customer7);
...
//		System.out.println("After Update"+customerDBDAO.getAllCustomers());
		TablesAndLinesUtils.printCustomersTable(customerDBDAO.getAllCustomers(), "After the update + delete customer tests");
