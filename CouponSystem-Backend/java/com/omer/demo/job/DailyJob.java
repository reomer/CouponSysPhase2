...
//	@Scheduled(fixedRate = 1000 * 60 * 60 * 24)
	...
	public void doTheJob() {
		...
		if (expiredCoupons != null || expiredCoupons.size() > 0) {
			TablesAndLinesUtils.printCouponsTable(expiredCoupons, "DaliyJOB - all expired coupons");
			...
			TablesAndLinesUtils.printCouponsTable(couponDBDAO.getAllCoupons(), "DaliyJOB - coupon list without expired coupons");
			System.out.println();
			System.out.println();
		} else {
